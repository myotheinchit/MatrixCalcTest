...
document.querySelector('.calculate').addEventListener('click', function (e) {
  ...
  resultSec.innerHTML = `<h1> The Toners in the bundle costs ${math.subset(
    matrixB,
    math.index(0, 0)
  )} mmk for each. </h1>
  <h1> The Serums in the bundle costs ${math.subset(
    matrixB,
    math.index(1, 0)
  )} mmk for each. </h1>
  <h1> The Masks in the bundle costs ${math.subset(
    matrixB,
    math.index(2, 0)
  )} mmk for each. </h1>`;
